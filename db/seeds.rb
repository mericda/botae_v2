...
Response.create!([{ response_id: 10, stage_id: 3 , step_id: 1, flow_id: 2 ,response_content: "I\'m designed by Meric Dagli, a graduate interaction design student at Carnegie Mellon University, who is originally from 🇹🇷" } ])
...
Response.create!([{ response_id: 12, stage_id: 3 , step_id: 1, flow_id: 2 ,response_content: "My father is Meric Dagli, an interaction design student from Carnegie Mellon University." } ])
