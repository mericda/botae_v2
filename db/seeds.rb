...
Response.create!([{ response_id: 8, stage_id: 2 , step_id: 2 ,response_content: "It is a bot, because you don\'t need another app in your phone, right?" } ])
...
Response.create!([{ response_id: 11, stage_id: 3 , step_id: 1 ,response_content: "My father is Meriç Dağlı, A Turkish graduate interaction design student at Carnegie Mellon University." } ])
Response.create!([{ response_id: 12, stage_id: 3 , step_id: 1 ,response_content: "My father is Meric Dagli, an interaction design student from Carnegie Mellon University." } ])
